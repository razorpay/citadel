var Octokit = (function(e) {
  ...
  function(e, r) {
    e.exports = function(e) {
      if (t[e]) return;
      console.warn(`DEPRECATED (@octokit/rest): ${e}`), (t[e] = 1);
    };
    const t = {};
  },
  function(e, r) {
      ...
      constructor(e, r, t, i) {
        super(e),
          ...
          Object.defineProperty(this, "code", {
            get: () => (
              console.warn("`error.code` is deprecated, use `error.status`."), r
            )
          }),
          (this.headers = t);
        const n = Object.assign({}, i);
        i.headers.authorization &&
          (n.headers = Object.assign({}, i.headers, {
            authorization: i.headers.authorization.replace(
              / .*$/,
              " [REDACTED]"
            )
          })),
  ...
  function(e, r, t) {
    e.exports = function(e, r, t, o) {
      i(
        `octokit.get${t.charAt(0).toUpperCase() +
          t.slice(
            1
      ...
      const p = n(r)[t];
      if (!p) {
        const e = new s(`No ${t} page found`, 404);
        return Promise.reject(e);
      }
      const a = {
        url: p,
        headers: (function(e, r) {
          const t = e.headers && e.headers["x-github-media-type"];
          if (!t || (r && r.accept)) return r;
          return (
            ((r = r || {}).accept =
              "application/vnd." +
              t.replace("; param=", ".").replace("; format=", "+")),
            r
          );
        })(r, o)
      };
  ...
  function(e, r, t) {
    e.exports = function(e, r, t) {
      ...
      return (
        ...
        (t = i.all([e, t].filter(Boolean), { isMergeableObject: n }))
      );
    };
    const i = t(20),
      n = t(8),
  ...
  function(e, r, t) {
    e.exports = function(e) {
      let r,
        ...
        a = e.headers,
        u = o(e, ["method", "baseUrl", "url", "headers", "request"]);
      const d = s(p);
  ...
  function(e, r, t) {
    e.exports = function(e) {
      ...
      let r,
        t,
        p = {};
      return ((e.request && e.request.fetch) || n)(
        e.url,
        Object.assign(
          {
            method: e.method,
        ...
        .then(i => {
          (t = i.url), (r = i.status);
          for (const e of i.headers) p[e[0]] = e[1];
          ...
          if (r >= 400)
            return i.text().then(t => {
              const i = new o(t, r, p, e);
              try {
        ...
        .then(e => ({ status: r, url: t, headers: p, data: e }))
        .catch(r => {
  ...
  function(e, r) {
    e.exports = function(e, r) {
      const t = r.headers;
      let i = e.request.endpoint(r).url;
      return {
        [Symbol.asyncIterator]: () => ({
          next: () =>
            i
              ? e
                  .request({ url: i, headers: t })
                  .then(
                    e => (
                      (i = ((e.headers.link || "").match(
                        /<([^>]+)>;\s*rel="next"/
                      ) || [])[1]),
                      { value: e }
                    )
  ...
  function(e, r, t) {
    const i = t(14),
      n = [t(41), t(42), t(47), t(51), t(53), t(55), t(57), t(61)];
  ...
  function(e, r, t) {
    e.exports = function(e, r) {
      ...
      const t = new n.Collection(),
        ...
        a = { hook: t, log: p, request: o(t, i, s(r, p)) };
      return e.forEach(e => e(a, r)), a;
    };
    const i = t(16).endpoint,
      n = t(33),
      s = t(37),
      o = t(39);
  },
  function(e, r, t) {
    const i = t(17),
      n = t(4),
      s = `octokit-request.js/${t(29).version} ${n()}`,
      o = t(30);
    e.exports = o(i, { headers: { "user-agent": s } });
  },
  function(e, r, t) {
    const i = t(18),
      n = t(27);
          ...
          if (this.isDefined(n) && "" !== n)
            if (
              ...
              (n = n.toString()),
                ...
                s.push(
                  this.encodeValue(r, n, this.isKeyOperator(r) ? t : null)
                );
            else if ("*" === i)
              Array.isArray(n)
                ? n.filter(this.isDefined).forEach(function(e) {
                    s.push(
                ...
                : Object.keys(n).forEach(function(e) {
                    this.isDefined(n[e]) &&
                      s.push(this.encodeValue(r, n[e], e));
                  }, this);
            else {
              var o = [];
              Array.isArray(n)
                ...
                : Object.keys(n).forEach(function(e) {
                    this.isDefined(n[e]) &&
                      ...
                      o.push(this.encodeValue(r, n[e].toString())));
                  }, this),
                this.isKeyOperator(r)
                  ? s.push(this.encodeUnreserved(t) + "=" + o.join(","))
                  : 0 !== o.length && s.push(o.join(","));
            }
          else
            ";" === r
              ? this.isDefined(n) && s.push(this.encodeUnreserved(t))
              : "" !== n || ("&" !== r && "?" !== r)
              ? "" === n && s.push("")
              : s.push(this.encodeUnreserved(t) + "=");
          return s;
        }),
              ...
              return e.replace(/\{([^\{\}]+)\}|([^\{\}]+)/g, function(e, n, s) {
                if (n) {
                  var o = null,
                    p = [];
                  if (
                    (-1 !== t.indexOf(n.charAt(0)) &&
                      ((o = n.charAt(0)), (n = n.substr(1))),
  ...
  function(e, r) {
    e.exports = function(e) {
      const r = e.match(t);
      if (!r) return [];
      return r.map(i).reduce((e, r) => e.concat(r), []);
    };
    const t = /\{[^}]+\}/g;
    function i(e) {
  ...
  function(e, r, t) {
    const i = t(4),
      n = `octokit-endpoint.js/${t(28).version} ${i()}`;
    e.exports = {
      method: "GET",
  ...
  function(e) {
    e.exports = {
      ...
      files: ["lib"],
      _resolved:
        "https://registry.npmjs.org/@octokit/request/-/request-2.4.0.tgz",
      _integrity:
        "sha512-Bm2P0duVRUeKhyepNyFg5GX+yhCK71fqdtpsw5Rz+PQPjSha8HYwPMF5QfpzpD8b6/Xl3xhTgu3V90W362gZ1A==",
      _from: "@octokit/request@2.4.0"
    };
  },
  function(e, r, t) {
    e.exports = function e(r, t) {
      const n = r.defaults(t);
  ...
  function(e, r, t) {
    ...
    function a(e, r, t) {
      ...
      (e.api = { remove: i }),
        ...
        ["before", "error", "after", "wrap"].forEach(function(i) {
          var o = t ? [r, i, t] : [r, i];
          (e[i] = e.api[i] = p(n, null).apply(null, o)),
            (e.remove[i] = e.api.remove[i] = p(s, null).apply(null, o));
        });
    }
    function u() {
      var e = { registry: {} },
    ...
    (g.Singular = function() {
      ...
      (e.exports = g),
      (e.exports.Hook = g),
      (e.exports.Singular = g.Singular),
      (e.exports.Collection = g.Collection);
  },
  function(e, r) {
  ...
  function(e, r) {
    e.exports = function(e, r, t, i) {
      ...
      e.registry[t].push({ hook: i, orig: n });
    };
  },
  function(e, r) {
    e.exports = function(e, r, t, i) {
    ...
    e.exports = function(e, r) {
      e.headers &&
        (e.headers = Object.keys(e.headers).reduce(
          (r, t) => ((r[t.toLowerCase()] = e.headers[t]), r),
          {}
        ));
      const t = { headers: e.headers || {}, request: e.request || {} };
      e.baseUrl && (t.baseUrl = e.baseUrl);
      e.userAgent && (t.headers["user-agent"] = e.userAgent);
      e.previews &&
        (t.headers.accept = e.previews.map(
          e => `application/vnd.github.${e}+json`
        ));
      e.timeout &&
        (r.warn(
          new Error(
            "new Octokit({timout}) is deprecated. Use {request: {agent}} instead. See https://github.com/octokit/rest.js#client-options"
          )
        ),
        (t.request.timeout = e.timeout));
      e.agent &&
        (r.warn(
          new Error(
            "new Octokit({agent}) is deprecated. Use {request: {agent}} instead. See https://github.com/octokit/rest.js#client-options"
          )
        ),
        (t.request.agent = e.agent));
      e.headers &&
        r.warn(
          new Error(
            "new Octokit({headers}) is deprecated. Use {userAgent, previews} instead. See https://github.com/octokit/rest.js#client-options"
          )
        );
      const s = t.headers["user-agent"],
        o = `octokit.js/${n.version} ${i()}`;
      return (t.headers["user-agent"] = [s, o].filter(Boolean).join(" ")), t;
    };
    const i = t(4),
      n = t(38);
  },
  ...
  function(e, r, t) {
    e.exports = function e(r, t, n) {
      const s = t.defaults(n);
      const o = function(e, r, t, n) {
        const s = r.merge(t, n);
      ...
      e.hook.wrap("request", (r, t) => {
        ...
        return r(t)
          .then(
            r => (
              e.log.info(
                `${n.method} ${s} - ${r.status} in ${Date.now() - i}ms`
              ),
              r
            )
          )
    ...
    e.exports = function(e, r) {
      if (r.auth)
        return void (e.authenticate = () => {
          e.log.warn(
            new Error(
              'octokit.authenticate() is deprecated and has no effect when "auth" option is set on Octokit constructor'
            )
          );
        });
      const t = { octokit: e, auth: !1 };
      (e.authenticate = i.bind(null, t)),
        e.hook.before("request", n.bind(null, t)),
        e.hook.error("request", s.bind(null, t));
    };
    const i = t(43),
      n = t(44),
      s = t(46);
  ...
  function(e, r, t) {
    e.exports = function(e, r) {
      ...
      if ("basic" === e.auth.type) {
        const t = i(`${e.auth.username}:${e.auth.password}`);
        return void (r.headers.authorization = `Basic ${t}`);
      }
      if ("token" === e.auth.type)
        return void (r.headers.authorization = `token ${e.auth.token}`);
      if ("app" === e.auth.type) {
        r.headers.authorization = `Bearer ${e.auth.token}`;
        const t = r.headers.accept
          .split(",")
          .concat("application/vnd.github.machine-man-preview+json");
        return void (r.headers.accept = n(t)
          .filter(Boolean)
          .join(","));
      }
      if (((r.url += -1 === r.url.indexOf("?") ? "?" : "&"), e.auth.token))
        return void (r.url += `access_token=${encodeURIComponent(
          e.auth.token
        )}`);
      const t = encodeURIComponent(e.auth.key),
        s = encodeURIComponent(e.auth.secret);
      r.url += `client_id=${t}&client_secret=${s}`;
    };
    const i = t(11),
      n = t(45);
  },
  function(e, r, t) {
    (function(r) {
      var t = 200,
        ...
        p = "object" == typeof r && r && r.Object === Object && r,
          ...
          (function(e, r, t) {
            if (r != r)
              return (function(e, r, t, i) {
                var n = e.length,
                  s = t + (i ? 1 : -1);
                for (; i ? s-- : ++s < n; ) if (r(e[s], s, e)) return s;
                return -1;
              })(e, c, t);
            var i = t - 1,
              n = e.length;
            for (; ++i < n; ) if (e[i] === r) return i;
            return -1;
          })(e, r, 0) > -1
        );
      }
      ...
      var y,
        ...
        w = (y = /[^.]+$/.exec((b && b.keys && b.keys.IE_PROTO) || ""))
          ? "Symbol(src)_1." + y
          : "",
        f = q.toString,
        v = _.hasOwnProperty,
      ...
      function A(e) {
        var r = -1,
          t = e ? e.length : 0;
        for (this.__data__ = new C(); ++r < t; ) this.add(e[r]);
      }
      function x(e, r) {
          ...
          ? (function(e, r, i) {
              ...
              e: for (; ++n < o; ) {
                ...
                if (((y = i || 0 !== y ? y : 0), p && h == h)) {
                  for (var q = u.length; q--; ) if (u[q] === h) continue e;
                  r && u.push(h), a.push(y);
  ...
  function(e, r, t) {
    e.exports = function(e, r, t) {
      const n = /required/.test(r.headers["x-github-otp"] || "");
      if (401 !== r.status || !n) throw r;
      if (
        401 === r.status &&
        n &&
        r.request &&
        r.request.headers["x-github-otp"]
      )
        throw new i(
      ...
      return Promise.resolve()
        ...
        .then(r => {
          const i = Object.assign(t, {
            headers: Object.assign({ "x-github-otp": r }, t.headers)
          });
  ...
  function(e, r, t) {
    e.exports = function(e, r) {
      if (!r.auth) return;
      s(r.auth);
      const t = { octokit: e, auth: r.auth };
      e.hook.before("request", i.bind(null, t)),
        e.hook.error("request", n.bind(null, t));
    };
    const i = t(48),
      n = t(49),
      s = t(50);
  ...
  function(e, r, t) {
    e.exports = function(e, r) {
      if ("string" == typeof e.auth) {
        if (
          ((r.headers.authorization = e.auth),
          /^Bearer /.test(e.auth) && !/machine-man/.test(r.headers.accept))
        ) {
          const e = r.headers.accept
            .split(",")
            .concat("application/vnd.github.machine-man-preview+json");
          r.headers.accept = e.filter(Boolean).join(",");
        }
        return;
      }
      if (e.auth.username) {
      ...
      if (e.auth.clientId) {
        if (/\/applications\/:?[\w_]+\/tokens\/:?[\w_]+($|\?)/.test(r.url)) {
          const t = i(`${e.auth.clientId}:${e.auth.clientSecret}`);
          return void (r.headers.authorization = `Basic ${t}`);
        }
        return (
          (r.url += -1 === r.url.indexOf("?") ? "?" : "&"),
          void (r.url += `client_id=${e.auth.clientId}&client_secret=${
            e.auth.clientSecret
          }`)
        );
      }
  ...
  function(e, r, t) {
    e.exports = function(e, r, t, n) {
      ...
      return (
        (t = e.request.endpoint.merge(r, t)),
        (function e(r, t, i) {
          return t.next().then(n => {
            if (n.done) return r;
            let s = !1;
            return (
              n.value.data.items && (n.value.data = n.value.data.items),
              (r = r.concat(
                i
                  ? i(n.value, function() {
                      s = !0;
      ...
      Object.keys(r).forEach(t => {
        e[t] || (e[t] = {}),
          Object.keys(r[t]).forEach(i => {
            let n = r[t][i];
            const s = ["method", "url", "headers"].reduce(
              (e, r) => (void 0 !== n[r] && (e[r] = n[r]), e),
              {}
            );
            s.request = { validate: n.params };
    ...
    e.exports = {
      ...
      apps: {
        ...
        checkAccountIsAssociatedWithAny: {
          method: "GET",
          params: {
            account_id: { required: !0, type: "integer" },
            page: { type: "integer" },
            per_page: { type: "integer" }
          },
      ...
      checks: {
        create: {
          ...
          params: {
            ...
            "output.annotations[].end_line": { required: !0, type: "integer" },
        ...
        setSuitesPreferences: {
          ...
          params: {
            ...
            "auto_trigger_checks[].setting": { required: !0, type: "boolean" },
            owner: { required: !0, type: "string" },
            repo: { required: !0, type: "string" }
          },
      ...
      issues: {
        addAssignees: {
          ...
          params: {
            ...
            number: { required: !0, type: "integer" },
            owner: { required: !0, type: "string" },
            repo: { required: !0, type: "string" }
          },
      ...
      licenses: {
        ...
        list: { method: "GET", params: {}, url: "/licenses" }
      },
      markdown: {
        render: {
          method: "POST",
      ...
      pulls: {
        ...
        createComment: {
          ...
          params: {
            ...
            position: { required: !0, type: "integer" },
            repo: { required: !0, type: "string" }
          },
        ...
        createCommentReply: {
          ...
          params: {
            body: { required: !0, type: "string" },
            in_reply_to: { required: !0, type: "integer" },
            number: { required: !0, type: "integer" },
            owner: { required: !0, type: "string" },
            repo: { required: !0, type: "string" }
          },
      ...
      repos: {
        ...
        updateBranchProtection: {
          ...
          params: {
            ...
            "required_status_checks.strict": { required: !0, type: "boolean" },
        ...
        uploadReleaseAsset: {
          method: "POST",
          params: {
            file: { mapTo: "data", required: !0, type: "string | object" },
    ...
    e.exports = function(e) {
      ...
      return (
        Object.keys(r).forEach(t => {
          ...
          /\./.test(t) &&
            ((a = t.replace(/\.[^.]+$/, "")),
            (g = "[]" === a.slice(-2)) && (a = a.slice(0, -2)),
            (u = n(e, a)),
            (d = "headers" === a || ("object" == typeof u && null !== u))),
            (g
              ? (n(e, a) || []).map(e => e[t.split(/\./).pop()])
              : [n(e, t)]
            ).forEach((r, n) => {
              const a = void 0 !== r,
                u = null === r,
              ...
              if ((o.required || a) && d && (!o.allowNull || !u)) {
                if (!o.allowNull && u)
                  throw new s(`'${c}' cannot be null`, 400, null, e);
                if (o.required && !a)
                  throw new s(
                    `Empty value for parameter '${c}': ${JSON.stringify(r)}`,
                    400,
                    null,
                    e
                  );
                if ("integer" === p) {
                  ...
                  if (((r = parseInt(r, 10)), isNaN(r)))
                    throw new s(
                      `Invalid value for parameter '${c}': ${JSON.stringify(
                        t
                      )} is NaN`,
                      400,
                      null,
                ...
                if (o.enum && -1 === o.enum.indexOf(r))
                  throw new s(
                    `Invalid value for parameter '${c}': ${JSON.stringify(r)}`,
                    400,
                    null,
                    e
                  );
                if (o.validation && !new RegExp(o.validation).test(r))
                  throw new s(
                    `Invalid value for parameter '${c}': ${JSON.stringify(r)}`,
                    400,
                    null,
                ...
                if ("object" === p && "string" == typeof r)
                  try {
                    r = JSON.parse(r);
                  } catch (t) {
                    throw new s(
                      `JSON parse error of value for parameter '${c}': ${JSON.stringify(
                        r
                      )}`,
                      400,
                      null,
  ...
  function(e, r, t) {
    (function(r) {
      var t = "Expected a function",
        ...
        y = /^(?:0|[1-9]\d*)$/,
        h = "object" == typeof r && r && r.Object === Object && r,
        q = "object" == typeof self && self && self.Object === Object && self,
        _ = h || q || Function("return this")();
      var b,
        w = Array.prototype,
        f = Function.prototype,
        v = Object.prototype,
        E = _["__core-js_shared__"],
        T = (b = /[^.]+$/.exec((E && E.keys && E.keys.IE_PROTO) || ""))
          ? "Symbol(src)_1." + b
          : "",
        k = f.toString,
        j = v.hasOwnProperty,
      ...
      function z(e, r) {
        for (var t = e.length; t--; ) if (J(e[t][0], r)) return t;
        return -1;
      }
      function $(e) {
        return (
      ...
      (F.prototype.clear = function() {
        ...
        (F.prototype.has = function(e) {
          var r = this.__data__;
          return A ? void 0 !== r[e] : j.call(r, e);
        }),
        (F.prototype.set = function(e, r) {
          return (this.__data__[e] = A && void 0 === r ? i : r), this;
        }),
      ...
      function V(e, r) {
        if ("function" != typeof e || (r && "function" != typeof r))
  ...
  function(e, r, t) {
    (function(r) {
      var t = "Expected a function",
        ...
        l = "object" == typeof r && r && r.Object === Object && r,
      ...
      var q,
        ...
        v = (q = /[^.]+$/.exec((f && f.keys && f.keys.IE_PROTO) || ""))
          ? "Symbol(src)_1." + q
          : "",
        E = b.toString,
        T = w.hasOwnProperty,
  ...
  function(e, r, t) {
    e.exports = function(e) {
      (e.getFirstPage = t(62).bind(null, e)),
        (e.getLastPage = t(64).bind(null, e)),
        (e.getNextPage = t(65).bind(null, e)),
        (e.getPreviousPage = t(66).bind(null, e)),
        (e.hasFirstPage = t(67)),
        (e.hasLastPage = t(68)),
        (e.hasNextPage = t(69)),
        (e.hasPreviousPage = t(70));
    };
  },
  function(e, r, t) {
    e.exports = function(e, r, t) {
